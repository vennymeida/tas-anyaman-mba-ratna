    ...
    const blogPosts = [
        {
            ...
            content: `
                ...
                <p>Woven bags are one of the fashion accessories made from traditional woven handicrafts that still have interest and competitiveness with modern bags. The results of woven bag crafts feature unique and timeless designs, as well as durable materials such as bamboo, plastic, rattan, pandan, or animal skin.</p>
                
                <p>However, caring for woven bags still needs to be considered so that these bags continue to look beautiful and durable. Starting from how to clean them to storing them. For those of you who don't know how to care for them properly, here are some tips you can follow!</p>
                
                <h2>Tips for Caring for Woven Bags to Stay Beautiful and Durable:</h2>

                <h3>1. Avoid Washing Bags, Clean Using a Cloth</h3>
                ...
                <h3>2. Use Baking Soda to Remove Odors from Woven Bags</h3>

                <p>Bags that have not been used for a long time will produce a smelly aroma. Avoid spraying perfume on the bag because it can damage the bag, so that it does not last long. You can use another alternative, such as putting baking soda in the bag and leaving it for 24 hours to remove the smell from the bag.</p>
                
                <h3>3. Avoid Woven Bags from Water</h3>
                ...
                <h3>4. Avoid Drying Woven Bags Under Hot Sunlight</h3>
                ...
                <h3>5. Check and Clean Your Bag Regularly</h3>

                <p>The last and most important tip, you need to check the condition of your woven bag regularly to ensure the condition and cleanliness of your woven bag. If you see any signs of damage to the material and stains on the weave, immediately repair and clean the bag, referring to the tips you have received.</p>
                
                If you are interested and want to try a woven bag made of premium plastic for fashion, souvenirs, and decoration needs, <a style="color: blue;" href="https://tas-anyaman-mba-ratna.vercel.app/products.html">Tas Anyaman Mba' Ratna</a> offers various woven bags with unique and charming motifs, designs, and sizes. Not only that, Mba' Ratna Woven Bags also provides custom design for the woven bag souvenirs. Discover information and select your favorite bag now.</p> 
            `,
            content_id: `
                ...
                <p>Tas anyaman merupakan salah satu aksesoris fashion yang terbuat dari kerajinan anyaman tradisional yang masih memiliki peminat dan daya saing dengan tas modern. Hasil kerajinan tas anyaman memiliki desain yang unik dan timeless serta material yang tahan lama seperti bambu, plastik, rotan, pandan, ataupun kulit hewan.</p>
                
                <p>Namun, merawat tas anyaman tetap perlu diperhatikan agar tas tersebut tetap terlihat cantik dan tahan lama. Mulai dari cara membersihkannya hingga penyimpanannya. Bagi kalian yang belum tahu cara merawatnya dengan baik, berikut beberapa tips yang bisa kalian ikuti! </p>
                
                <h2>Tips Merawat Tas Anyaman Agar Tetap Cantik dan Tahan Lama:</h2>

                <h3>1. Hindari Mencuci Tas, Bersihkan Menggunakan Kain</h3>
                ...
                <h3>2. Gunakan Baking Soda untuk Menghilangkan Bau pada Tas Anyaman</h3>
                ...
                <h3>3. Hindarkan Tas Anyaman Dari Air</h3>
                ...
                <h3>4. Hindari Mengeringkan Tas Anyaman di Bawah Sinar Matahari yang Panas</h3>
        ...
        },
        {
            ...
            author_id: "Aprilia Tri Anggraeni",
            content: `
                <p>Currently, the use of plastic bags in several shopping centres has been banned by the government. The appeal to use plastic bags as a substitute for paper bags is not half-hearted. The ban on the use of plastic bags is enforced in supermarkets to convenience stores that are spread out without providing plastic shopping bags. The ban on the use of plastic bags is the government's effort to reduce plastic waste that is difficult to decompose, so it damages the environment and sustainable ecosystems.</p>
                
                <p>This requires us to find alternatives of plastic bags for shopping. If we only shop for one or two items, we may not need a shopping bag. However, what if we shop for quite a lot of monthly needs? We need a shopping bag that is big enough to accommodate our groceries. Here are recommendations for those of you who are looking for alternative shopping bags to replace plastic bags at affordable prices, and that can be used every day.</p>
                ...
                <p>Currently, most minimarkets, supermarkets, and shopping centres provide paper bags for shopping bags as a substitute for plastic bags. This is because paper bags are made of recyclable materials that can reduce the negative impact on the environment. Paper bags can be reused as long as they are not torn or damaged in any other way. The disadvantage of paper bags is that they cannot be used for wet shopping items.</p>
                ...
                <p>Woven shopping bags are made from various types of materials, from bamboo to water hyacinth. The lightweight material and spacious design make this woven bag the favourite of many people. In addition, this bag is fairly durable, so it can be used many times. Woven bags can be obtained at affordable prices, but have good quality. This bag has various sizes from small to large, so it can hold a lot of items. Woven bags are strong and elastic, allowing them to withstand heavy loads. In addition, this environmentally friendly bag looks aesthetic with a unique design, so that it still looks stylish when shopping at supermarkets or traditional markets.</p>
                
                <p>For those of you who want to find woven bags as an alternative to plastic shopping bags, you can visit <a style="color: blue;" href="https://tas-anyaman-mba-ratna.vercel.app/products.html">Tas Anyaman Mba' Ratna products.</a>. The price is affordable, starting from IDR 15 thousand at Tas Anyaman Mba' Ratna store.</p>
            `,
            content_id: `
                ...
                <p>Bagi kalian yang ingin mencari tas anyaman sebagai alternatif kantong belanja plastik, kalian bisa mengunjungi <a style="color: blue;" href="https://tas-anyaman-mba-ratna.vercel.app/products.html">Halaman Produk Tas Anyaman Mba' Ratna</a>. Harga terjangkau mulai dari IDR 15 ribu di toko Tas Anyaman Mba' Ratna.</p>
            `
        },
        {
            id: 3,
            title: "Affordable and Functional Wedding Souvenir Bag Recommendations",
            ...
            content: `
                ...
                <img style="width: 30%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;" src="images/article3-image1.jpeg" alt="Affordable and Functional Wedding Souvenir Bag Recommendations">
                <p>Woven shopping bags have the benefit of replacing environmentally unfriendly plastic shopping bags. Woven bags are durable because the material is durable and versatile. You can choose a shopping bag with a design that is adjusted to your wedding theme, such as embroidered names of the bride and groom or the wedding date. This bag can also be printed with a typical wedding design, such as a flower pattern or a monogram of the bride and groom.</p>
                
                <h3>2. Small Pouch Bag</h3>
                <p>Small pouch bags made of premium plastic are perfect as a place to store jewellery, chocolate, candy, or even other miniature souvenirs. The simple yet elegant design makes pouch bags an excellent choice.</p>
                
                <h3>3. Mini Woven Bag</h3>
                <img style="width: 30%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;" src="images/miniebag.png" alt="Affordable and Functional Wedding Souvenir Bag Recommendations">
                ...
                <img style="width: 30%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;" src="images/article3-image3.jpeg" alt="Affordable and Functional Wedding Souvenir Bag Recommendations">
                ...
                <img style="width: 30%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;" src="images/premiumbag.png" alt="Affordable and Functional Wedding Souvenir Bag Recommendations">
                ...
                <p>If you are interested in woven bags as wedding souvenirs at affordable prices, but have good quality, you can get them at the Mba' Ratna Woven Bag store or visit <a style="color: blue;" href="https://tas-anyaman-mba-ratna.vercel.app/products.html">Tas Anyaman Mba' Ratna products.</a></p>
            `,
            content_id: `
                ...
                <p>Jika kalian tertarik dengan tas anyaman sebagai souvenir pernikahan dengan harga terjangkau namun memiliki kualitas yang baik, kalian bisa mendapatkannya di toko Tas Anyaman Mba' Ratna atau kunjungi <a style="color: blue;" href="https://tas-anyaman-mba-ratna.vercel.app/products.html">Tas Anyaman Mba' Ratna</a></p>
            `
        }
    ];
