document.addEventListener('DOMContentLoaded', function() {
    ...
    const blogPosts = [
        ...
        },
        {
            ...
            author: "Aprilia Tri Anggraeni",
            content: `
                <h2>Recommended Shopping Bags to Replace Plastic Bags</h2>
                ...
                <h3>Canvas Bags</h3>
                <img style="width: 30%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;" src="images/article2-detail1.png" alt="Recommended Shopping Bags to Replace Plastic Bags" id="blog-detail-img">
                ...
                <h3>Paper Bag</h3>
                <img style="width: 30%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;" src="images/article2-detail2.png" alt="Recommended Shopping Bags to Replace Plastic Bags" id="blog-detail-img">
                ...
                <img style="width: 30%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;" src="images/article2-detail3.png" alt="Recommended Shopping Bags to Replace Plastic Bags" id="blog-detail-img">
                ...
                <img style="width: 30%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;" src="images/article2-image4.png" alt="Recommended Shopping Bags to Replace Plastic Bags" id="blog-detail-img">
                ...
                <h3>Woven Bag</h3>
                <img style="width: 30%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;" src="images/article3-image5.png" alt="Recommended Shopping Bags to Replace Plastic Bags" id="blog-detail-img">
        ...
        },
        {
            ...
            author: "Aprilia Tri Anggraeni",
            content: `
                <h2>Cheap and Functional Wedding Souvenir Bag Recommendations</h2>
                ...
                <img style="width: 30%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;" src="images/article3-image1.jpeg" alt="Cheap and Functional Wedding Souvenir Bag Recommendations" id="blog-detail-img">
                ...
                <img style="width: 30%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;" src="images/article3-image3.jpeg" alt="Cheap and Functional Wedding Souvenir Bag Recommendations" id="blog-detail-img">
                ...
                <img style="width: 30%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;" src="images/article3-image4.jpeg" alt="Cheap and Functional Wedding Souvenir Bag Recommendations" id="blog-detail-img">
                ...
                <img style="width: 30%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;" src="images/article3-image5.png" alt="Cheap and Functional Wedding Souvenir Bag Recommendations" id="blog-detail-img">
